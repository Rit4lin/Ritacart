...
type ReceiptDetail = ReceiptSummary & { items: Array<{ id: number; raw_name: string; quantity: string | null; unit: string | null; unit_price: string | null; price_per_kg: string | null; total_price: string | null }> }
...
export default function App() {
  ...
  return <div className="app-shell">
    ...
    <main className="content">{message && <p className="notice" role="status">{message}</p>}{page === 'inicio' && <Home overview={overview} loading={loading} onShowReceipt={showReceipt} />}{page === 'compras' && <Purchases receipts={receipts} selected={selected} onSelect={showReceipt} onUpload={uploadPdf} />}{page === 'configuracion' && <Configuration status={importStatus} onRun={runImport} />}</main>
  </div>
}
