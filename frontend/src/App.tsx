...
export default function App() {
  ...
  useEffect(() => { if (page === 'estadisticas') void Promise.all([loadStatistics(statisticsRange), loadProductInsights()]) }, [page, statisticsRange])
...
function Statistics({ data, insights, range, onRangeChange, topProducts, onShowProduct }: { data: Statistics | null; insights: ProductInsights | null; range: StatisticsRange; onRangeChange: (range: StatisticsRange) => void; topProducts: ProductSummary[]; onShowProduct: (id: number) => void }) {
